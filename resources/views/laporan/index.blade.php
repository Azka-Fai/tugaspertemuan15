        ...
        <div class="card-body">
            <form method="GET" class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <a href="{{ route('transaksi.laporan.pdf', request()->all()) }}" class="btn btn-success" target="_blank">
                        <i class="bi bi-printer"></i> Cetak PDF
                    </a>
                    <button type="button" class="btn btn-info" onclick="window.print()">
                        <i class="bi bi-printer"></i> Cetak Layar
                    </button>
                </div>
            </form>
        </div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $trx->denda_berjalan ? 'Rp ' . number_format($trx->denda_berjalan, 0, ',', '.') : '-' }}</td>
                    </tr>
                    @empty
