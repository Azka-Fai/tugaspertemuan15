<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-6">
                ...
                @php
                    $transaksiTerlambat = \App\Models\Transaksi::with(['anggota', 'buku'])
                        ...
                        ->get();
                @endphp
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-2 {{ $transaksiTerlambat->count() > 0 ? 'border-red-500' : 'border-transparent' }}">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-red-600">{{ $transaksiTerlambat->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6 border-2 border-red-400">
                <div class="p-6">
                    <h3 class="text-lg font-semibold mb-4 text-red-600">
                        <svg class="inline h-5 w-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                        </svg>
                        Daftar Buku Terlambat Dikembalikan
                    </h3>
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-red-50">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-red-600 uppercase tracking-wider">Anggota</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-red-600 uppercase tracking-wider">Buku</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-red-600 uppercase tracking-wider">Batas Kembali</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-red-600 uppercase tracking-wider">Terlambat</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-red-600 uppercase tracking-wider">Est. Denda</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ $tl->tanggal_kembali->format('d M Y') }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <a href="{{ route('transaksi.show', $tl->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                            Detail →
                                        </a>
                                    </td>
                                </tr>
