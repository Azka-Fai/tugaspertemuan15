...
![CRUD Buku](image/CRUDbuku.png) 
 
### 3. Manajemen Data Anggota (CRUD Anggota)
![CRUD Anggota](image/CRUDanggota.png)
 
### 4. Transaksi Peminjaman Buku
![Transaksi Peminjaman](image/formpinjambuku.png)
 
### 5. Proses Pengembalian Buku & Denda
![Pengembalian Buku](image/pengembalianbuku.png)
 
### 6. Global Search & Filter
![Global Search & Filter](image/globalsearch.png)
